...
Player = function() {
  ...
  this.UpdateBullets = function() {
    for (var i = 0; i < this.bullets.length; i++) {
      ...
      if (b.rect.y + b.rect.height < 0) done = true;
  ...
  this.Draw = function(ctx) {
    for (var i = 0; i < this.bullets.length; i++) this.bullets[i].Draw(ctx);
